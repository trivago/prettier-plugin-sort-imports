...
export const getSortedNodesModulesNames = (
    modules: (ImportSpecifier | ImportDefaultSpecifier | ImportNamespaceSpecifier)[],
) =>
    modules
        .filter((m) => ['ImportSpecifier', 'ImportDefaultSpecifier', 'ImportNamespaceSpecifier'].includes(m.type))
